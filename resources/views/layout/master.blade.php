            ...
            $(document).ready(function() {
                ...
                var table = $('.dataTableExample').DataTable({
                    ...
                    initComplete: function() {
                        // Adjust column widths and set consistent padding for cells
                        this.api().columns.adjust().draw();
                        $('table.dataTableExample td').css('padding', '12px 15px');
                    }
                });
                // Column-wise search functionality
                $('.dataTableExample .filters input').on('input', function() {
                ...
                // Optional: Style the search inputs uniformly
                $('.dataTableExample .filters input').css('padding', '6px');
            });
    </script>
</body>
