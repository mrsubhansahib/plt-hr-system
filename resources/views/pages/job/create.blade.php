                    ...
                    <div class="row mb-3">
                        <div class="col-md-3 mt-3">
                            ...
                            <select class="form-control" required name="user_id">
                                ...
                                <option value="">{{ $employee->first_name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-3 mt-3">
                        ...
                        <div class="col-md-3 mt-3">
                            ...
                            <input class="form-control" type="text" name="main_job" />
                        </div>
                        <div class="col-md-3 mt-3">
                        ...
                        <div class="col-md-3 mt-3">
                            <label class="form-label">Contract Returned<span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-3 mt-3">
                            ...
                            <input class="form-control" type="text" name="jd_returned" />
                        </div>
                        <div class="col-md-3 mt-3">
