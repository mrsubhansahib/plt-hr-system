                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-3 mt-3">
                                ...
                                <select class="form-control form-select" required name="title">
                                    ...
                                    <option value="Administration Assistant/Wages Clerk (REC)">Administration
                                        Assistant/Wages Clerk (REC)</option>
                                    ...
                                    <option value="Box Office / Information Sales Co-Ordinator">Box Office / Information
                                        Sales Co-Ordinator</option>
                                    ...
                                    <option value="Credit Controller / Finance Assistant">Credit Controller / Finance
                                        Assistant</option>
                                    ...
                                    <option value="Executive Manager (Human Resources)">Executive Manager (Human Resources)
                                    </option>
                                    ...
                                    <option value="Grant Funding/Administration Manager/PA">Grant Funding/Administration
                                        Manager/PA</option>
                                    ...
                                    <option value="Relief Assistant Customer Focus Manager">Relief Assistant Customer Focus
                                        Manager</option>
                                    <option value="Relief Customer Focus Manager">Relief Customer Focus Manager</option>
                                    <option value="Repair and Maintenance Operative">Repair and Maintenance Operative
                                    </option>
