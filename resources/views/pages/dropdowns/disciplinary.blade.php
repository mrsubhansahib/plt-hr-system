...
@section('content')
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Disciplinary Dropdowns</li>
        </ol>
    </nav>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between py-2">
                        <h4 class="py-2">Disciplinary Dropdowns</h4>
                        ...
                        <table class="table dataTableExample">
                            ...
                            <tbody>
                                @foreach ($dropdowns as $dropdown)
                                    @if ($dropdown->module_type === 'Disciplinary')
                                        <tr>
                                            <td>{{ $dropdown->name }}</td>
