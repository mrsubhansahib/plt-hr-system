        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-3 mt-3">
                        ...
                        <select class="form-control form-select" name="disability"
                            value="{{ $user->disability }}" disabled>
                ...
                <div class="mt-4 mb-3 border-bottom pb-3">
                    <h5 class="text-primary mb-3">Job #{{ $index + 1 }}</h5>
                    <div class="row">
                        <div class="col-md-3 mt-3">
                        ...
                        <div class="col-md-3 mt-3">
                            ...
                            <input type="text" class="form-control" value="{{ ucfirst($job->main_job) }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Facility</label>
                            <input type="text" class="form-control" value="{{ $job->facility }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Cost Centre</label>
                            <input type="text" class="form-control" value="{{ $job->cost_center }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Start Date</label>
                            <input type="text" class="form-control" value="{{ \Carbon\Carbon::parse($job->start_date)->format('d-m-Y') }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Termination Date</label>
                            <input type="text" class="form-control"
                                value="{{ $job->termination_date ? \Carbon\Carbon::parse($job->termination_date)->format('d-m-Y') : '' }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Rate of Pay</label>
                            <input type="text" class="form-control" value="{{ $job->rate_of_pay }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Pay Frequency</label>
                            <input type="text" class="form-control" value="{{ $job->pay_frequency }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Number of Hours</label>
                            <input type="text" class="form-control" value="{{ $job->number_of_hours }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Contract Type</label>
                            <input type="text" class="form-control" value="{{ $job->contract_type }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Contract Returned</label>
                            <input type="text" class="form-control" value="{{ ucfirst($job->contract_returned) }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">JD Returned</label>
                            <input type="text" class="form-control" value="{{ ucfirst($job->jd_returned) }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">DBS Required</label>
                            <input type="text" class="form-control" value="{{ ucfirst($job->dbs_required) }}" disabled>
                        </div>
                ...
                <div class="mt-4 mb-3 border-bottom pb-3">
                    <h5 class="text-primary mb-3">Disclosure #{{ $index + 1 }}</h5>
                    <div class="row">

                        <div class="col-md-3 mt-3">
                            <label class="form-label">DBS Level</label>
                            <input type="text" class="form-control" value="{{ $disclosure->dbs_level }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Date Requested</label>
                            <input type="text" class="form-control" value="{{ $disclosure->date_requested }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Date on Certificate</label>
                            <input type="text" class="form-control" value="{{ $disclosure->date_on_certificate }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Certificate Number</label>
                            <input type="text" class="form-control" value="{{ $disclosure->certificate_no }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Paid Liberata</label>
                            <input type="text" class="form-control" value="{{ ucfirst($disclosure->paid_liberata) }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Reimbursed Candidate</label>
                            <input type="text" class="form-control" value="{{ $disclosure->reimbursed_candidate }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Invoice Sent</label>
                            <input type="text" class="form-control" value="{{ ucfirst($disclosure->invoice_sent) }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Contract Type</label>
                            <input type="text" class="form-control" value="{{ $disclosure->contract_type }}" disabled>
                        </div>

                        <div class="col-md-12 mt-3">
                            <label class="form-label">Notes</label>
                            <textarea class="form-control" rows="3" disabled>{{ $disclosure->notes }}</textarea>
                        </div>
                ...
                <div class="mt-4 mb-3 border-bottom pb-3">
                    ...
                    <div class="row">
                        <div class="col-md-3 mt-3">
                            ...
                            <input class="form-control" type="text" value="{{ $sickness->reason_for_absence }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Date From</label>
                            <input class="form-control" type="text"
                                value="{{ \Carbon\Carbon::parse($sickness->date_from)->format('d-m-Y') }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Date To</label>
                            <input class="form-control" type="text"
                                value="{{ \Carbon\Carbon::parse($sickness->date_to)->format('d-m-Y') }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Total Hours</label>
                            <input class="form-control" type="text" value="{{ $sickness->total_hours }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Self Certification Form Received</label>
                            <input class="form-control" type="text" value="{{ ucfirst($sickness->certification_form_received) }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Fit Note Received</label>
                            <input class="form-control" type="text" value="{{ ucfirst($sickness->fit_note_received) }}" disabled>
                        </div>
                ...
                <h3 class="my-4 text-center">Capability Details</h3>
                <hr>
                @foreach ($user->capabilities as $index => $capability)
                <div class="mt-4 mb-3 border-bottom pb-3">
                    <h5 class="text-primary mb-3">Capability #{{ $index + 1 }}</h5>
                    <div class="row">
                        <div class="col-md-3 mt-3">
                            <label class="form-label">On Capability Procedure</label>
                            <input type="text" class="form-control" value="{{ ucfirst($capability->on_capability_procedure) }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Capability Stage</label>
                            <input type="text" class="form-control" value="{{ $capability->stage }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Date</label>
                            <input type="text" class="form-control" value="{{ $capability->date }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Outcome</label>
                            <input type="text" class="form-control" value="{{ $capability->outcome }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Warning Issued Type</label>
                            <input type="text" class="form-control" value="{{ $capability->warning_issued_type }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Review Date</label>
                            <input type="text" class="form-control" value="{{ $capability->review_date }}" disabled>
                        </div>
                ...
                <div class="mt-4 mb-3 border-bottom pb-3">
                    <h5 class="text-primary mb-3">Disciplinary #{{ $index + 1 }}</h5>
                    <div class="row">
                        <div class="col-md-3 mt-3">
                            <label class="form-label">Reason for Disciplinary</label>
                            <input class="form-control" type="text" value="{{ $disciplinary->reason_for_disciplinary }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Date of Hearing</label>
                            <input class="form-control" type="text" value="{{ $disciplinary->hearing_date }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Outcome</label>
                            <input class="form-control" type="text" value="{{ $disciplinary->outcome }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Suspended</label>
                            <input class="form-control" type="text" value="{{ ucfirst($disciplinary->suspended) }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Date Suspended</label>
                            <input class="form-control" type="text" value="{{ $disciplinary->date_suspended }}" disabled>
                        </div>
                ...
                <div class="mt-4 mb-3 border-bottom pb-3">
                    <h5 class="text-primary mb-3">Lateness #{{ $index + 1 }}</h5>
                    <div class="row">
                        <div class="col-md-3 mt-3">
                            <label class="form-label">Lateness Triggered</label>
                            <input class="form-control" type="text" value="{{ $lateness->lateness_triggered }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Lateness Stage</label>
                            <input class="form-control" type="text" value="{{ $lateness->lateness_stage }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Level of Warning Issued</label>
                            <input class="form-control" type="text" value="{{ $lateness->warning_level }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Outcome / Action Taken</label>
                            <input class="form-control" type="text" value="{{ $lateness->outcome }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Review Date</label>
                            <input class="form-control" type="text" value="{{ $lateness->review_date }}" disabled>
                        </div>
                ...
                <h3 class="my-4 text-center">Training Details</h3>
                <hr>

                @foreach ($user->trainings as $index => $training)
                <div class="mt-4 mb-3 border-bottom pb-3">
                    <h5 class="text-primary mb-3">Training #{{ $index + 1 }}</h5>
                    <div class="row">
                        <div class="col-md-3 mt-3">
                            <label class="form-label">Training Title</label>
                            <input type="text" class="form-control" value="{{ $training->training_title }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Course Date</label>
                            <input type="text" class="form-control" value="{{ $training->course_date }}" disabled>
                        </div>

                        <div class="col-md-3 mt-3">
                            <label class="form-label">Renewal Date</label>
                            <input type="text" class="form-control" value="{{ $training->renewal_date }}" disabled>
                        </div>

                        <div class="col-md-12 mt-3">
                            <label class="form-label">Notes</label>
                            <textarea class="form-control" rows="3" disabled>{{ $training->notes }}</textarea>
                        </div>
                    </div>
