            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3 border-bottom border-2 pb-2 pb-4">
                        ...
                        <div class="col-md-3 mt-3">
                            ...
                            <input class="form-control" type="text" required name="default_cost_center"
                                value="{{ $user->default_cost_center ? $user->default_cost_center : 'empty' }}" disabled />
                        </div>
                        ...
                        <div class="col-md-3 mt-3">
                            <label class="form-label">Emergency Contact 1 Mobile
                                <input class="form-control" type="number" placeholder="Phone Number" required
                                    ...
                                    value="{{ $user->emergency_1_ph_no ? $user->emergency_1_ph_no : 'empty' }}" disabled />
                        </div>
                        <div class="col-md-3 mt-3">
                        ...
                        <div class="col-md-3 mt-3">
                            ...
                            <input class="form-control" type="number" placeholder="phone number"
                                ...
                                value="{{ $user->emergency_1_home_ph ? $user->emergency_1_home_ph : 'empty' }}" disabled />
                        </div>
                        <div class="col-md-3 mt-3">
                        ...
                        <div class="col-md-3 mt-3">
                            ...
                            <input class="form-control" type="number" placeholder="phone number"
                                ...
                                value="{{ $user->emergency_2_home_ph ? $user->emergency_2_home_ph : 'empty' }}" disabled />
                        </div>
                    </div>
                    @if ($user->jobs->count() > 0)
                        <h3 class=" text-center w-25 m-auto border-bottom border-2 pb-2 ">Job Details</h3>
                            ...
                            <div class="mt-4 mb-3 border-bottom pb-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mt-3">
                                        ...
                                        <textarea class="form-control" rows="3" disabled>{{ $job->notes ? $job->notes : 'empty' }}</textarea>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                    ...
                    @if ($user->disclosures->count() > 0)
                        ...
                        @endforeach
                    @else
                        <p class="text-muted text-center fs-5 border-2 border w-50 m-auto p-3">No disclosure records found.
                        </p>
                        <hr>
                    @endif
                        ...
                        @foreach ($user->sicknesses as $index => $sickness)
                            <div class="mt-4 mb-3 border-bottom pb-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mt-3">
                                        <label class="form-label">Notes</label>
                                        <textarea class="form-control" rows="3" disabled>{{ $sickness->notes ? $sickness->notes : 'empty' }}</textarea>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                    @else
                        <p class="text-muted text-center fs-5 border-2 border w-50 m-auto p-3">No sickness records found.
                        </p>
                        <hr>
                    @endif
                        ...
                        @foreach ($user->capabilities as $index => $capability)
                            <div class="mt-4 mb-3 border-bottom pb-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mt-3">
                                        <label class="form-label">Notes</label>
                                        <textarea class="form-control" rows="3" disabled>{{ $capability->notes ? $capability->notes : 'empty' }}</textarea>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                    @else
                        <p class="text-muted text-center fs-5 border-2 border w-50 m-auto p-3">No capability records found.
                        </p>
                        <hr>
                    @endif
                        ...
                        @foreach ($user->disciplinaries as $index => $disciplinary)
                            <div class="mt-4 mb-3 border-bottom pb-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mt-3">
                                        <label class="form-label">Notes</label>
                                        <textarea class="form-control" rows="3" disabled>{{ $disciplinary->notes ? $disciplinary->notes : 'empty' }}</textarea>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                    @else
                        <p class="text-muted text-center fs-5 border-2 border w-50 m-auto p-3">No disciplinary records
                            found.</p>
                        <hr>
                    @endif
                        ...
                        @foreach ($user->latenesses as $index => $lateness)
                            <div class="mt-4 mb-3 border-bottom pb-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mt-3">
                                        <label class="form-label">Notes</label>
                                        <textarea class="form-control" rows="3" disabled>{{ $lateness->notes ? $lateness->notes : 'empty' }}</textarea>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                    @else
                        <p class="text-muted text-center fs-5 border-2 border w-50 m-auto p-3">No lateness records found.
                        </p>
                        <hr>
                    @endif
