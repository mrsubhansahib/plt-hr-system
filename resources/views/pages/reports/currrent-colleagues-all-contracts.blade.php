...
@section('content')
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Current Colleagues All Contracts</li>
        </ol>
    </nav>
    @livewire('currrent-colleagues-all-contracts')
@endsection
    ...
    <script>
        document.addEventListener('livewire:load', function() {
            ...
            Livewire.hook('message.processed', (message, component) => {
                ...
                console.log('DataTable re-initialized after Livewire update');
